    ...
    <div className="w-full max-w-md">
      ...
      <div className="bg-[#ffffff] border border-[#e2e8f0] rounded-2xl p-8 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-[#1e293b] mb-2" htmlFor="email">
              Email address
            </label>
            <input
              id="email"
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              <label className="block text-sm font-medium text-[#1e293b]" htmlFor="password">
                Password
              </label>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 pr-11 text-sm rounded-xl"
                placeholder="••••••••"
                required
              />
              <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold py-3 rounded-xl text-sm transition-all hover:shadow-[0_0_20px_rgba(124,58,237,0.4)] disabled:opacity-70"
          >
        ...
        <button className="w-full bg-[#ffffff] hover:bg-[#f1f5f9] border border-[#e2e8f0] text-[#1e293b] font-medium py-3 rounded-xl text-sm transition-all flex items-center justify-center gap-3">
