...
class BusinessProfileController {
  getBusinessProfiles = async (req: AuthRequest, res: Response) => {
    try {
      // Mock data for Phase 2 UI Integration
      const profiles = [
        {
          id: 'mock-gbp-1',
          locationId: '1234567890',
          businessName: 'Sharma Dental Clinic',
          address: '123 Health Ave, Mumbai, MH 400001',
          websiteUrl: 'https://sharmadental.com',
          ...
          googleAccount: { email: 'arjun@sharmadental.com' }
        }
      ];
